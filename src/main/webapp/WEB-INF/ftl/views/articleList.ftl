...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {name: 'updateTime', index: 'updateTime', width: 70, sortable: false},
                {
                    ...
                    formatter: function (cellValue, options, rowObject) {
                        var detail = '';
                        detail = '<button class="btn btn-sm btn-info" onclick="editArticle(' + rowObject.id + ')">编辑</button>';
                        return detail;
                    }
                }
            ],
            ...
            caption: "文章列表",
            editurl: "/api/article/editArticle"
            //,autowidth: true,
...
//                    viewicon : 'ace-icon fa fa-search-plus grey',
    ...
    function editArticle(articleId){
        window.location.href = '/api/article/updateArticle/'+articleId
    }
</script>
