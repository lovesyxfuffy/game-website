...
<form class="form-horizontal" role="form" id="uploadForm">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="aboutUs" name="aboutUs" placeholder="aboutUs"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户协议</label>

        <div class="col-sm-9">
            <input type="text" id="userAgreement" name="userAgreement" placeholder="userAgreement"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="contactUs" name="contactUs" placeholder="contactUs"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">商务合作</label>

        <div class="col-sm-9">
            <input type="text" id="cooperation" name="cooperation" placeholder="cooperation"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
...
<script type="application/javascript">
    $("#submitButton").click(function () {
        ...
        $.ajax({
            ...
            type: "post",
            data: form,
            url: "/api/metaManage/uploadAboutUs",
            processData: false,
            contentType: false,
            error: function (e) {
                alert("错误！！");
