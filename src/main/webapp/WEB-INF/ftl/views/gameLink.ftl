...
<form class="form-horizontal" role="form" id="uploadForm">
    ...
    <div class="form-group">
        <div class="col-sm-9">
            <input multiple="" name="QRCode" type="file" id="id-input-file-3"/>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">App Store下载地址</label>

        <div class="col-sm-9">
            <input type="text" id="iosDownloadUrl" name="iosDownloadUrl" placeholder="iosDownloadUrl"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Android下载地址</label>

        <div class="col-sm-9">
            <input type="text" id="androidDownloadUrl" name="androidDownloadUrl" placeholder="androidDownloadUrl"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">PC版本下载地址</label>

        <div class="col-sm-9">
            <input type="text" id="pcDownloadUrl" name="pcDownloadUrl" placeholder="pcDownloadUrl"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">首页视频地址</label>

        <div class="col-sm-9">
            <input type="text" id="mainPageVideoUrl" name="mainPageVideoUrl" placeholder="mainPageVideoUrl"
                   class="col-xs-10 col-sm-5"/>
        </div>
    </div>
